...
func initAmqp() {
	...
	err = ch.ExchangeDeclare(
		"post-detail-data-exchange", // name of the exchange
		"direct",                    // type
		true,                        // durable
	...
	q, err = ch.QueueDeclare(
		"post-detail-data-queue", // name, leave empty to generate a unique name
		true,                     // durable
	...
	err = ch.QueueBind(
		...
		"post-detail-data-exchange", // sourceExchange
		false,                       // noWait
		nil,                         // arguments
	)
...
func main() {
	...
	for r := range replies {
		var insertData models.PostDetailModel
		...
		response, err := postController.CreatePostDetailProcess(insertData)
		if err != nil {
