...
func initAmqp() {
	...
	err = ch.ExchangeDeclare(
		"delete-post-exchange", // name of the exchange
		"direct",               // type
		true,                   // durable
	...
	q, err = ch.QueueDeclare(
		"delete-post-data-queue", // name, leave empty to generate a unique name
		true,                     // durable
	...
	err = ch.QueueBind(
		...
		"go-test-key-delete",   // bindingKey
		"delete-post-exchange", // sourceExchange
		false,                  // noWait
		nil,                    // arguments
	)
...
func main() {
	...
	for r := range replies {
		...
		_, err := postController.DeletePostDataProcess(id, insertData)
		if err != nil {
